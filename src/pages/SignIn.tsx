...
export default function SignIn() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // If redirected, page will reload — no need to setGoogleLoading(false)
    } catch (err: any) {
    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-background">
      <div className="w-full max-w-sm">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 rounded-xl border border-border bg-card px-4 py-3 text-sm font-medium text-foreground hover:bg-muted transition-colors disabled:opacity-50 mb-6 shadow-sm"
        >
